return {
    ...
    BASE_KNOCKBACK = 300,
    KNOCKBACK_DECAY = 8,
    MOVEMENT_KNOCKBACK_MULTIPLIER = 2,
    VERTICAL_KNOCKBACK_SCALE = 1,
    SWING_UPWARD_FORCE = 180,
    AIR_FRICTION = 3,
    GROUND_FRICTION = 15,
    ...
    FREEZE_BOLT_ACCELERATION = 0.75,
    FREEZE_BOLT_COOLDOWN = 4,
